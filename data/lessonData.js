...
<pre class="code-example">console.log("Hello World!");</pre>
    ...
    2: {
        ...
        content: `
            ...
            <h3>Feladat:</h3>
            <p>Írd be pontosan ezt a kódot:</p>
...
console.log("Hossz:", szamok.length);</pre>
            ...
            Ezután:
            <ul>
                <li><code>console.log(szamok[0]);</code> – kiírja az első elemet (1),</li>
                <li><code>console.log("Hossz:", szamok.length);</code> – kiírja a tömb hosszát (4).</li>
            </ul>
...
console.log(szemely.nev);</pre>
            ...
            A <code>console.log(szemely.nev);</code> csak a név tulajdonság értékét írja ki, vagyis <em>"Anna"</em>.</p>
    ...
    7: {
        ...
        content: `
            ...
            <p>(Ez elméleti példa, mert a DOM elem nem létezik.)</p>
...
<pre class="code-example">document.getElementById("cim").innerText = "Új cím!";</pre>
    ...
    8: {
        ...
        content: `
            ...
            <p>(DOM nélkül nem fut le — de a kódot ellenőrizzük)</p>
...
<pre class="code-example">document.getElementById("gomb").onclick = function() {
    alert("Megnyomtad!");
            ...
            <div class="code-runner">
                <textarea class="code-input"></textarea>
                <button class="run-btn"
                    data-expected='document.getElementById("gomb").onclick=function(){alert("Megnyomtad!");};'
                    onclick="runTask(this)">▶ Futtatás</button>
                <div class="output-box"></div>
            </div>
        `
...
<pre class="code-example">fetch("https://api.example.com")
  .then(res => res.json())
